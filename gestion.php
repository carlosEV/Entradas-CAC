...
if(isset($_COOKIE["cookie-user"]) AND isset($_COOKIE["cookie-psw"])){ /* SI ESTAN DEFINIDAS LAS COOKIES EJECUTA EL HTML */
				...
				<br>
					<form action="entrada.php" method="POST" class="formulario"><!-- FORMULARIO -->
						...
						<br>							
							...
							<div class="row">
								...
								<div class="col-md-2 form-group">
									<label for="genero">Género</label><br>
										<input type="radio" name="genero" value="masculino" checked="masculino">Masculino<br>
							...
							<div class="row">
								<div class="col-md-8">
									<button type="reset" class="btn btn-danger btn-xs">Borrar</button> <!-- BOTON RESET -->

									<a href="logout.php" class="btn btn-danger btn-xs">Cerrar sesión</a> <!-- BOTON CERRAR SESION -->	
								</div>
								<div class="col-md-2">
...
<?php
		...
		header("location: index.php");// SI HAN CADUCADO COOKIES REDIRIGE A gestion.php
	}
